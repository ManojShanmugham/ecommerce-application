...
echo"<h4 align='center'>LAPTOPS</h4>
	<table>
	<tr>
	<td width='20%' align='center'><strong>BRAND</strong></td>
	<td width='20%' align='center'><strong>MODEL NUMBER</strong></td>
	...
	<td width='10%' align='center'><strong>STORAGE(TB)</strong></td>
...
<?php
					...
					$query = "SELECT brand,model_no,color,ram,storage,display_size,price,P.p_id,P.availability as qty 
							  FROM category C,product P JOIN laptop L
							  WHERE C.c_type = 'Laptop' AND P.P_id = L.P_id";
					...
					while($rows = mysqli_fetch_assoc($result))
						{
							...
							echo "
								<tr >
								<td width='20%'><strong>$brand</strong></td>
								<td width='20%'><strong>$model_no</strong></td>
								<td width='10%'><strong>$color</strong></td>
								<td width='10%'><strong>$price</strong></td>
								<td width='10%'><strong>$ram</strong></td>
								<td width='10%'><strong>$storage</strong></td>
								<td width='10%'><strong>$display_size</strong></td>
								<td width='20%' align='center'><a href='insert2.php?p_id=$p_id&user_id=$u_id&qty=$quantity'>Add to CART</a>
								</tr>
								";
							}
